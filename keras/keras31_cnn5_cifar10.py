...
model = Sequential()
# Block 1
model.add(Conv2D(150, (2, 2), activation='relu', input_shape=(32, 32, 3)))  # 필터 = 150, 커널사이즈 = (2,2) , 인풋쉐이프, RGB = (32, 32, 3)
...
#모델저장
model.save("c:\_data\_save\cifar\keras31_cnn5_save_0122_model.h5") 
