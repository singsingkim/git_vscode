...
#     filepath='..\_data\_save\MCP\keras26_9_MCP.hdf5'
#     )
...
# model.save_weights("..\_data\_save\keras26_9_save_weights.h5")

model=load_model('..\_data\_save\MCP\keras26_9_MCP.hdf5')
