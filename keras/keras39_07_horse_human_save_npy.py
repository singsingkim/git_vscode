...
# ================================================================
# np_path = 'C:\_data\horse_human\_save_npy\\'
# np.save(np_path + 'keras39_7_x_train.npy', arr=xy_train[0][0])
# np.save(np_path + 'keras39_7_y_train.npy', arr=xy_train[0][1])
# np.save(np_path + 'keras39_7_x_test.npy', arr=xy_test[0][0])
# np.save(np_path + 'keras39_7_y_test.npy', arr=xy_test[0][1])
# print('성공')
