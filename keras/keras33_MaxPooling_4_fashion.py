...
model.add(Conv2D(50, (3,3), activation='relu')) #전달 (N,25,25,10)
model.add(Conv2D(100,(4,4))) #전달 (N,22,22,15)
model.add(MaxPooling2D())
...
model.fit(x_train, y_train, batch_size=1000, verbose= 1, epochs= 3000, validation_split=0.2 )
