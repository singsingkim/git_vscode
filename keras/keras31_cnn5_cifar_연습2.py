...
history = model.fit(x_train, y_train, epochs=10000, batch_size=100, verbose=2, validation_split=0.2, callbacks=[es])

#모델저장
model.save("c:\_data\_save\cifar\keras31_cnn5_save_model.h5") 
